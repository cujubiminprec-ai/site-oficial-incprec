...
import { loadFloatingButtons } from "@/pages/admin/tabs/FloatingButtonsTab";
import { FloatingButtonConfig } from "@/mocks/floating-buttons";
...
export default function FloatingButtons() {
  ...
  const [buttons, setButtons] = useState<FloatingButtonConfig[]>(loadFloatingButtons);

  useEffect(() => {
    const handleUpdate = () => setButtons(loadFloatingButtons());
