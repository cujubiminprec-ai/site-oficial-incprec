...
export default function Footer() {
  ...
  const contrachequeUrl = localStorage.getItem("inprec_contracheque_url") || "";
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 py-6 border-b border-white/10">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Link
              ...
              title="Programa Pró-Gestão RPPS – MPS"
            >
              <div className="w-9 h-9 flex items-center justify-center rounded-lg flex-shrink-0" style={{ backgroundColor: "#003366" }}>
                <i className="ri-medal-2-line text-yellow-300 text-lg"></i>
              </div>
              <div>
                <p className="text-white text-xs font-bold leading-tight group-hover:text-yellow-300 transition-colors">Pró-Gestão RPPS</p>
                <p className="text-white/40 text-[10px]">MPS • Certificado</p>
              </div>
            </Link>
            {/* Acesso Gov.br */}
            <a
