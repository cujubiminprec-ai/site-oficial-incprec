...
export const STORAGE_KEY_TRANSPARENCIA = "inprec_documentos_admin";
...
export const STORAGE_KEY_TRANSPARENCIA_MENUS = "inprec_transparencia_menus";
...
export function obterMenusPrimariosDinamicos(): TransparenciaMenu[] {
  try {
    const s = localStorage.getItem(STORAGE_KEY_TRANSPARENCIA_MENUS);
    return s ? JSON.parse(s) : defaultMenusPrimarios;
  } catch {
