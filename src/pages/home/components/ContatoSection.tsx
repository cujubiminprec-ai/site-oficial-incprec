...
export default function ContatoSection() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch("https://readdy.ai/api/form/d7eh5ci1i3t7k9116kj0", {
        method: "POST",
          ...
          <div className="w-full lg:w-[40%]">
            ...
            <div className="flex flex-col gap-5">
              {[
                ...
                { icone: "ri-time-line", titulo: "Atendimento", valor: config.horario || "De Segunda a Sexta, das 07:30h às 13:30h" },
              ].map((item) => (
          ...
          <div className="w-full lg:w-[60%]">
            <div className="bg-white border border-gray-100 rounded-2xl p-8">
              {status === "success" ? (
                ...
                <form onSubmit={handleSubmit} data-readdy-form id="contato-inprec" className="flex flex-col gap-5">
