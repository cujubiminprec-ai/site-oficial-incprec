...
import { grupos, Gestor } from "@/mocks/gestores";
...
export default function QuemSomosPage() {
  ...
  const [gestores, setGestores] = useState<Gestor[]>(() => carregarGestoresAtualizados());
  ...
  useEffect(() => {
    const atualizar = () => setGestores(carregarGestoresAtualizados());
