...
const PASTAS: PastaInfo[] = [
  ...
  },
  {
    id: "home-atalhos",
    label: "Atalhos Home",
    icone: "ri-folder-shield-line",
    descricao: "Arquivos anexados aos atalhos da página inicial",
    aceitos: ".pdf, .doc, .docx, .xls, .xlsx, .csv, .ppt, .pptx, .zip",
    mimes: ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "text/csv", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "application/zip"],
    cor: "#0F766E",
  },
  {
    id: "planilhas",
  ...
  {
    id: "eventos",
    label: "Imagens Eventos",
    icone: "ri-calendar-event-line",
    descricao: "Imagens para eventos e capacitações",
    aceitos: ".jpg, .jpeg, .png, .webp",
    mimes: ["image/jpeg", "image/png", "image/webp"],
    cor: "#2563EB",
  },
