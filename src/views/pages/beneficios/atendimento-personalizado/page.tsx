...
const canais = [
  { canal: "Presencial", desc: "Av. Condor, Nº 2588, Centro, Cujubim — RO. Atendimento: Segunda a Sexta — 07h30 às 13h30.", icon: "ri-building-2-line", acao: "Ver no Mapa", href: "/enderecos" },
  { canal: "WhatsApp", desc: "Envie mensagem para nosso WhatsApp: (69) 99250-9093. Receba orientação direta da equipe.", icon: "ri-whatsapp-line", acao: "Enviar Mensagem", href: "https://wa.me/5569992509093" },
  { canal: "E-mail", desc: "Envie sua dúvida ou documentação: inprec@cujubim.ro.gov.br. Respondemos rápido.", icon: "ri-mail-line", acao: "Enviar E-mail", href: "mailto:inprec@cujubim.ro.gov.br" },
  { canal: "Telefone", desc: "Ligue para (69) 99250-9093 — Segunda a Sexta — 07h30 às 13h30. Fale com nossa equipe.", icon: "ri-phone-line", acao: "Ligar Agora", href: "tel:69992509093" },
];
